...
;		this.repaint();
	...
	public void interes() {
		...
		JLabel panelRosa = new JLabel();
		panelRosa.setBounds(20,350,465,200);
		panelRosa.setOpaque(true);
